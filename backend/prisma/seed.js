...
async function main() {
  ...
  const products = [
    ...
    { name: 'Ceramic Vase - Wide Flared', slug: 'ceramic-vase-wide-flared', sku: 'FS-POT-004', description: 'Beautiful wide-mouthed ceramic vase in cream. Perfect for large bouquets and statement arrangements.', price: 25000, categorySlug: 'pots-vases', productType: 'vase', imageUrl: IMG + '1581783898377-1c85bf937427?w=600&h=600&fit=crop', careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'cream', tags: 'vases,ceramic,wide,flared,large-bouquet' },
    { name: 'Bud Vase - Glass Set 3', slug: 'bud-vase-glass-set-3', sku: 'FS-POT-005', description: 'Set of 3 small glass bud vases in varying heights. Ideal for single stems and small arrangements.', price: 12000, categorySlug: 'pots-vases', productType: 'vase', imageUrl: IMG + '1581783898377-1c85bf937427?w=600&h=600&fit=crop', careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'clear', tags: 'vases,glass,bud,set,small' },
  ];
