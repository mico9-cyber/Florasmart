...
const rolePermissions = {
  ...
  GARDENER: ['VIEW_DASHBOARD', 'USE_CHATBOT', 'MANAGE_PROFILE', 'VIEW_NOTIFICATIONS'],
};
...
async function main() {
  ...
  const PEX_SUFFIX = '/pexels-photo-{id}.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&fit=crop';
  function pex(id) { return PEX + id + PEX_SUFFIX.replace('{id}', id); }

  const products = [
    { name: 'Monstera Deliciosa', slug: 'monstera-deliciosa', sku: 'FS-PLT-001', description: 'The iconic Swiss cheese plant with large, fenestrated leaves. A stunning statement piece for any room.', price: 35000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(10176334), careLevel: 'easy', lightRequirement: 'bright indirect light', waterRequirement: 'moderate', soilType: 'well-draining potting mix', temperatureRange: '18-30°C', growthSize: '60-120cm', tags: 'indoor,statement,large,pet-friendly-no', featured: true },
    { name: 'Snake Plant', slug: 'snake-plant', sku: 'FS-PLT-002', description: 'Nearly indestructible snake plant with tall sword-like leaves. Perfect for beginners and low-light spaces.', price: 15000, categorySlug: 'indoor-plants', productType: 'plant', imageUrl: pex(17489483), careLevel: 'easy', lightRequirement: 'low to bright indirect', waterRequirement: 'low', soilType: 'cactus mix', temperatureRange: '15-30°C', growthSize: '30-120cm', tags: 'indoor,beginners,low-light,air-purifying', featured: true },
    { name: 'Peace Lily', slug: 'peace-lily', sku: 'FS-PLT-003', description: 'Elegant white blooms and glossy dark leaves. One of the best air-purifying indoor plants.', price: 18000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(15783250), careLevel: 'easy', lightRequirement: 'low to bright indirect', waterRequirement: 'moderate', soilType: 'rich potting mix', temperatureRange: '18-27°C', growthSize: '30-60cm', tags: 'indoor,flowering,air-purifying,shade-tolerant' },
    { name: 'Red Rose Bush', slug: 'rose-bush-red-velvet', sku: 'FS-PLT-004', description: 'Stunning hybrid tea rose with deep red velvety blooms. A garden classic loved across Rwanda.', price: 22000, categorySlug: 'outdoor-plants', productType: 'plant', imageUrl: pex(36756552), careLevel: 'moderate', lightRequirement: 'full sun', waterRequirement: 'moderate', soilType: 'rich loamy soil', temperatureRange: '15-28°C', growthSize: '60-120cm', tags: 'outdoor,flowering,rose,perennial', featured: true },
    { name: 'Gardenia Jasminoides', slug: 'gardenia-jasminoides', sku: 'FS-PLT-005', description: 'Fragrant white flowers with a sweet intoxicating scent. Thrives in Rwandan highlands.', price: 18000, categorySlug: 'outdoor-plants', productType: 'plant',     imageUrl: pex(24200646), careLevel: 'moderate', lightRequirement: 'partial shade', waterRequirement: 'moderate', soilType: 'acidic well-draining', temperatureRange: '18-25°C', growthSize: '60-150cm', tags: 'outdoor,flowering,fragrant,acid-loving' },
    { name: 'Hibiscus Rosa-Sinensis', slug: 'hibiscus-rosa-sinensis', sku: 'FS-PLT-006', description: 'Vibrant tropical hibiscus with large crimson blooms. A beloved garden flower in Rwanda.', price: 25000, categorySlug: 'outdoor-plants', productType: 'plant', imageUrl: pex(8766413), careLevel: 'easy', lightRequirement: 'full sun', waterRequirement: 'moderate', soilType: 'well-draining loamy', temperatureRange: '20-32°C', growthSize: '100-250cm', tags: 'outdoor,flowering,tropical,showy', featured: true },
    { name: 'Bougainvillea Spectabilis', slug: 'bougainvillea-spectabilis', sku: 'FS-PLT-007', description: 'Stunning climbing plant with brilliant magenta bracts. Perfect for Rwandan garden walls and trellises.', price: 20000, categorySlug: 'outdoor-plants', productType: 'plant',     imageUrl: pex(29983700), careLevel: 'easy', lightRequirement: 'full sun', waterRequirement: 'low', soilType: 'well-draining any', temperatureRange: '18-35°C', growthSize: '200-500cm', tags: 'outdoor,climbing,flowering,drought-tolerant', featured: true },
    { name: 'Frangipani (Plumeria)', slug: 'frangipani-plumeria', sku: 'FS-PLT-008', description: 'Exquisitely fragrant flowers in pink and white. Thrives in warm Rwandan gardens.', price: 28000, categorySlug: 'indoor-plants', productType: 'plant', imageUrl: pex(30130352), careLevel: 'moderate', lightRequirement: 'full sun', waterRequirement: 'low', soilType: 'well-draining sandy', temperatureRange: '20-35°C', growthSize: '150-500cm', tags: 'indoor,flowering,fragrant,tropical', featured: true },
    { name: 'Lavender English', slug: 'lavender-english', sku: 'FS-SD-001', description: 'Aromatic English lavender seeds. Grow your own fragrant purple blooms for gardens and sachets.', price: 3500, categorySlug: 'seeds', productType: 'seed',     imageUrl: pex(6471708), careLevel: 'easy', lightRequirement: 'full sun', waterRequirement: 'low', soilType: 'well-draining alkaline', temperatureRange: '15-25°C', growthSize: '30-60cm', tags: 'seeds,aromatic,purple,drought-tolerant', featured: true },
    { name: 'Sunflower Giant', slug: 'sunflower-giant', sku: 'FS-SD-002', description: 'Giant sunflower seeds that grow up to 3m tall with massive 30cm flower heads.', price: 2500, categorySlug: 'seeds', productType: 'seed', imageUrl: pex(772571), careLevel: 'easy', lightRequirement: 'full sun', waterRequirement: 'moderate', soilType: 'any well-draining', temperatureRange: '18-30°C', growthSize: '200-350cm', tags: 'seeds,annual,tall,children-friendly' },
    { name: 'Mixed Wildflower Meadow', slug: 'mixed-wildflower-meadow', sku: 'FS-SD-003', description: 'A beautiful blend of native wildflowers. Perfect for pollinator gardens.', price: 4500, categorySlug: 'seeds', productType: 'seed',     imageUrl: pex(7813243), careLevel: 'easy', lightRequirement: 'full sun to partial', waterRequirement: 'low', soilType: 'any', temperatureRange: '10-28°C', growthSize: '20-80cm', tags: 'seeds,wildflower,pollinator,native' },
    { name: 'Premium Rose Bouquet', slug: 'premium-rose-bouquet', sku: 'FS-FLW-001', description: 'A dozen premium long-stem red roses arranged by master florists. Perfect for any romantic occasion.', price: 55000, categorySlug: 'flowers', productType: 'flower', imageUrl: pex(1393437), careLevel: 'easy', lightRequirement: 'bright indirect', waterRequirement: 'daily', temperatureRange: '15-25°C', color: 'red', occasion: 'romance', tags: 'flowers,bouquet,roses,romantic,gift', featured: true },
    { name: 'Tropical Orchid Arrangement', slug: 'tropical-orchid-arrangement', sku: 'FS-FLW-004', description: 'Exquisite orchid arrangement featuring vibrant blooms. A sophisticated gift for any occasion.', price: 65000, categorySlug: 'flowers', productType: 'flower',     imageUrl: pex(6207449), careLevel: 'moderate', lightRequirement: 'bright indirect', waterRequirement: 'low', temperatureRange: '18-28°C', color: 'purple', occasion: 'any', tags: 'flowers,orchid,tropical,premium,gift', featured: true },
    { name: 'Dried Lavender Bundle', slug: 'dried-lavender-bundle', sku: 'FS-FLW-003', description: 'Hand-tied dried lavender bundles. Bring lasting fragrance and rustic charm to any space.', price: 10000, categorySlug: 'flowers', productType: 'flower', imageUrl: pex(4997806), careLevel: 'easy', lightRequirement: 'any', waterRequirement: 'none', temperatureRange: 'any', color: 'purple', tags: 'flowers,dried,lavender,aromatic,long-lasting' },
    { name: 'Jasmine Flowering Plant', slug: 'jasmine-flowering-plant', sku: 'FS-PLT-009', description: 'Enchantingly fragrant jasmine blooms that perfume the evening air. Ideal for Rwandan verandas.', price: 16000, categorySlug: 'outdoor-plants', productType: 'plant',     imageUrl: pex(37558227), careLevel: 'moderate', lightRequirement: 'full sun to partial', waterRequirement: 'moderate', soilType: 'well-draining fertile', temperatureRange: '18-30°C', growthSize: '100-300cm', tags: 'outdoor,flowering,fragrant,climbing' },
    { name: 'Bird of Paradise', slug: 'bird-of-paradise', sku: 'FS-PLT-010', description: 'Stunning crane-like flowers in orange and blue. A tropical showstopper for Rwandan gardens.', price: 35000, categorySlug: 'outdoor-plants', productType: 'plant', imageUrl: pex(32554970), careLevel: 'moderate', lightRequirement: 'full sun', waterRequirement: 'moderate', soilType: 'well-draining fertile', temperatureRange: '18-32°C', growthSize: '100-150cm', tags: 'outdoor,flowering,tropical,showy', featured: true },
    { name: 'Marigold African', slug: 'marigold-african', sku: 'FS-SD-004', description: 'Vibrant African marigold seeds producing large golden-orange blooms. A Rwandan garden favorite.', price: 3000, categorySlug: 'seeds', productType: 'seed',     imageUrl: pex(17892586), careLevel: 'easy', lightRequirement: 'full sun', waterRequirement: 'low', soilType: 'any well-draining', temperatureRange: '15-30°C', growthSize: '30-60cm', tags: 'seeds,marigold,flowering,annual,pollinator' },
    { name: 'Poinsettia Pulcherrima', slug: 'poinsettia-pulcherrima', sku: 'FS-PLT-011', description: 'Brilliant red bracts that bring festive color. A popular ornamental in Rwandan homes.', price: 20000, categorySlug: 'indoor-plants', productType: 'plant', imageUrl: pex(35257723), careLevel: 'moderate', lightRequirement: 'bright indirect', waterRequirement: 'moderate', soilType: 'well-draining potting mix', temperatureRange: '18-25°C', growthSize: '50-120cm', tags: 'indoor,flowering,colorful,festive' },
    { name: 'Aloe Vera', slug: 'aloe-vera', sku: 'FS-PLT-012', description: 'Versatile succulent with healing properties. Thrives in Rwandan sun with minimal care.', price: 12000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(33202074), careLevel: 'easy', lightRequirement: 'bright indirect to direct', waterRequirement: 'low', soilType: 'cactus mix sandy', temperatureRange: '18-32°C', growthSize: '30-60cm', tags: 'indoor,succulent,medicinal,drought-tolerant' },
    ...
    { name: 'Terracotta Pot Set - 3 Sizes', slug: 'terracotta-pot-set', sku: 'FS-POT-002', description: 'Classic terracotta pot set in 3 sizes. Essential for every plant lover.', price: 12000, categorySlug: 'pots-vases', productType: 'pot',     imageUrl: pex(1605255), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'terracotta', tags: 'pots,terracotta,set,classic' },
    { name: 'Glass Vase - Tall Cylinder', slug: 'glass-vase-tall-cylinder', sku: 'FS-POT-003', description: 'Elegant tall cylindrical glass vase. Perfect for showcasing long-stem flowers.', price: 18000, categorySlug: 'pots-vases', productType: 'vase',     imageUrl: pex(2543299), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'clear', tags: 'vases,glass,modern,tall' },
    { name: 'Pruning Shears Set', slug: 'pruning-shears-set', sku: 'FS-TOOL-001', description: 'Professional-grade stainless steel pruning shears with ergonomic handles. Bypass design for clean cuts.', price: 25000, categorySlug: 'garden-tools', productType: 'tool',     imageUrl: pex(6764325), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, tags: 'tools,pruning,shears,stainless-steel', featured: true },
    { name: 'Garden Trowel Set', slug: 'garden-trowel-set', sku: 'FS-TOOL-002', description: 'Set of 3 ergonomic garden trowels with rust-resistant coated steel heads.', price: 12000, categorySlug: 'garden-tools', productType: 'tool', imageUrl: pex(4503269), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, tags: 'tools,trowel,set,ergonomic' },
    { name: 'Watering Can - Copper', slug: 'watering-can-copper', sku: 'FS-TOOL-003', description: 'Beautiful copper watering can with elegant design. Holds 2L with a precision rose spout.', price: 30000, categorySlug: 'garden-tools', productType: 'tool',     imageUrl: pex(8894568), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'copper', tags: 'tools,watering,copper,decorative' },
    { name: 'Organic All-Purpose Fertilizer', slug: 'organic-all-purpose-fertilizer', sku: 'FS-FRT-001', description: 'Balanced organic fertilizer (5-5-5) suitable for all indoor and outdoor plants. 1kg bag.', price: 8000, categorySlug: 'fertilizers', productType: 'fertilizer',     imageUrl: pex(25974981), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, tags: 'fertilizer,organic,all-purpose,npk', featured: true },
    { name: 'Liquid Seaweed Plant Food', slug: 'liquid-seaweed-plant-food', sku: 'FS-FRT-002', description: 'Concentrated liquid seaweed extract. Boosts root growth and plant vitality. 500ml bottle.', price: 6000, categorySlug: 'fertilizers', productType: 'fertilizer',     imageUrl: pex(30801526), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, tags: 'fertilizer,liquid,seaweed,organic' },
    { name: 'Rose & Flower Food', slug: 'rose-flower-food', sku: 'FS-FRT-003', description: 'Specialized fertilizer formulated for roses and flowering plants. 800g granules.', price: 7000, categorySlug: 'fertilizers', productType: 'fertilizer',     imageUrl: pex(31673795), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, tags: 'fertilizer,rose,flowering,granules' },
    { name: 'Garden Gnome - Classic', slug: 'garden-gnome-classic', sku: 'FS-DEC-001', description: 'Traditional hand-painted resin garden gnome with red hat. 20cm tall.', price: 12000, categorySlug: 'decorative-items', productType: 'decorative',     imageUrl: pex(18297345), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'multicolor', tags: 'decorative,garden,gnome,outdoor', featured: true },
    { name: 'Solar Fairy Lights - 50 LED', slug: 'solar-fairy-lights', sku: 'FS-DEC-002', description: 'Warm white solar-powered fairy lights. 10m length with 50 LEDs. Perfect for garden ambiance.', price: 15000, categorySlug: 'decorative-items', productType: 'decorative', imageUrl: pex(1124960), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'warm white', tags: 'decorative,lights,solar,fairy,outdoor' },
    { name: 'Wind Chime - Bamboo', slug: 'wind-chime-bamboo', sku: 'FS-DEC-003', description: 'Soothing bamboo wind chime with deep resonant tones. 60cm length.', price: 10000, categorySlug: 'decorative-items', productType: 'decorative',     imageUrl: pex(9153309), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'natural', tags: 'decorative,wind-chime,bamboo,outdoor' },
    { name: 'Spider Plant', slug: 'spider-plant', sku: 'FS-PLT-013', description: 'Hardy trailing plant with arching green and white striped leaves. Excellent air purifier and pet-safe.', price: 10000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(5331924), careLevel: 'easy', lightRequirement: 'bright indirect light', waterRequirement: 'moderate', soilType: 'well-draining potting mix', temperatureRange: '15-28°C', growthSize: '30-60cm', tags: 'indoor,air-purifying,pet-safe,trailing' },
    { name: 'Boston Fern', slug: 'boston-fern', sku: 'FS-PLT-014', description: 'Lush green fern with feathery fronds. Thrives in humidity and indirect light. Pet-safe and elegant.', price: 14000, categorySlug: 'indoor-plants', productType: 'plant', imageUrl: pex(2919584), careLevel: 'moderate', lightRequirement: 'partial shade', waterRequirement: 'high', soilType: 'rich potting mix', temperatureRange: '15-25°C', growthSize: '30-90cm', tags: 'indoor,pet-safe,humidity-loving,feathery' },
    { name: 'Areca Palm', slug: 'areca-palm', sku: 'FS-PLT-015', description: 'Elegant indoor palm with feathery fronds. Excellent air purifier and pet-friendly. Grows up to 2m indoors.', price: 22000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(9041608), careLevel: 'easy', lightRequirement: 'bright indirect light', waterRequirement: 'moderate', soilType: 'well-draining potting mix', temperatureRange: '18-28°C', growthSize: '120-200cm', tags: 'indoor,palm,air-purifying,pet-safe,statement', featured: true },
    { name: 'Calathea Orbifolia', slug: 'calathea-orbifolia', sku: 'FS-PLT-016', description: 'Stunning round leaves with silver-green stripes. A dramatic pet-safe plant for indirect light spaces.', price: 20000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(8244420), careLevel: 'expert', lightRequirement: 'low to bright indirect', waterRequirement: 'high', soilType: 'well-draining potting mix', temperatureRange: '18-27°C', growthSize: '40-60cm', tags: 'indoor,pet-safe,colorful,high-humidity' },
    { name: 'Orchid Plant - Phalaenopsis', slug: 'orchid-plant-phalaenopsis', sku: 'FS-PLT-017', description: 'Elegant moth orchid with long-lasting white blooms. A sophisticated gift that blooms for months.', price: 30000, categorySlug: 'indoor-plants', productType: 'plant',     imageUrl: pex(5030458), careLevel: 'moderate', lightRequirement: 'bright indirect light', waterRequirement: 'low', soilType: 'orchid bark mix', temperatureRange: '18-28°C', growthSize: '30-60cm', tags: 'indoor,orchid,flowering,pet-safe,elegant', featured: true },
    { name: 'Tulip Bouquet - Mixed Colors', slug: 'tulip-bouquet-mixed', sku: 'FS-FLW-005', description: 'Vibrant mixed tulip bouquet in assorted colors. Perfect spring gift for any occasion.', price: 35000, categorySlug: 'flowers', productType: 'flower',     imageUrl: pex(3874607), careLevel: 'easy', lightRequirement: 'bright indirect', waterRequirement: 'daily', temperatureRange: '15-24°C', color: 'multicolor', occasion: 'any', tags: 'flowers,bouquet,tulip,spring,colorful', featured: true },
    { name: 'Sunflower Bouquet - Happy', slug: 'sunflower-bouquet-happy', sku: 'FS-FLW-006', description: 'Bright and cheerful sunflower bouquet. Brings sunshine to any room.', price: 25000, categorySlug: 'flowers', productType: 'flower',     imageUrl: pex(11259478), careLevel: 'easy', lightRequirement: 'bright indirect', waterRequirement: 'moderate', temperatureRange: '15-28°C', color: 'yellow', occasion: 'cheer-up', tags: 'flowers,bouquet,sunflower,cheerful,bright' },
    { name: 'Mixed Bouquet - Rainbow', slug: 'mixed-bouquet-rainbow', sku: 'FS-FLW-007', description: 'Colorful mixed flower bouquet with roses, lilies, and seasonal blooms. Perfect for any celebration.', price: 45000, categorySlug: 'flowers', productType: 'flower', imageUrl: pex(1484657), careLevel: 'easy', lightRequirement: 'bright indirect', waterRequirement: 'daily', temperatureRange: '15-26°C', color: 'multicolor', occasion: 'celebration', tags: 'flowers,bouquet,mixed,colorful,premium' },
    { name: 'Ceramic Vase - Wide Flared', slug: 'ceramic-vase-wide-flared', sku: 'FS-POT-004', description: 'Beautiful wide-mouthed ceramic vase in cream. Perfect for large bouquets and statement arrangements.', price: 25000, categorySlug: 'pots-vases', productType: 'vase',     imageUrl: pex(6945389), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'cream', tags: 'vases,ceramic,wide,flared,large-bouquet' },
    { name: 'Bud Vase - Glass Set 3', slug: 'bud-vase-glass-set-3', sku: 'FS-POT-005', description: 'Set of 3 small glass bud vases in varying heights. Ideal for single stems and small arrangements.', price: 12000, categorySlug: 'pots-vases', productType: 'vase',     imageUrl: pex(8903350), careLevel: null, lightRequirement: null, waterRequirement: null, soilType: null, temperatureRange: null, growthSize: null, color: 'clear', tags: 'vases,glass,bud,set,small' },
  ];
