...
const ALLOWED_TRANSITIONS = {
  PENDING: ['PROCESSING', 'CONFIRMED', 'PREPARING', 'CANCELLED'],
  PROCESSING: ['CONFIRMED', 'PREPARING', 'READY_FOR_DELIVERY', 'CANCELLED'],
  CONFIRMED: ['PREPARING', 'READY_FOR_DELIVERY', 'CANCELLED'],
